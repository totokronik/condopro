...
if($nacionalidad == 1){
	if(validaRut($numero_documento) === FALSE){
		$msg = "<script type='text/javascript'>alert('El Rut ingresado es inválido'); window.location.href = '../../Vistas/pages/Modulo_registrar_entrada/entrada.index.php'</script>";
		echo $msg;
	}else{
