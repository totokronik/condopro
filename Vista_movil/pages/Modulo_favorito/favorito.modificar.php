...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Modificar favorito</h1>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <br>
                <!-- /.panel-heading -->
                <form action="../../../Clases/Favorito/class.modificar.php" method="POST" accept-charset="utf-8">
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                            $id = $_GET['id'];
                            $sql = "SELECT
                            fr.id_favorito as favorito,
                            rc.id_residente as residente,
                            fr.numero_documento as documento,
                            fr.nombre as nombre,
                            us.nombres as nombre_usuario,
                            us.apellidos as apellido
                            FROM favoritos_residente fr
                            JOIN residente_condominio rc ON fr.id_residente = rc.id_residente
                            JOIN usuarios us ON rc.id_usuario = us.id_usuario
                            WHERE fr.id_favorito = $id";
                            $resultado2 = mysqli_query($conexion, $sql);
                            while ($fila = $resultado2->fetch_assoc()) {
                            $favorito = $fila['favorito'];
                            $residente = $fila['residente'];
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" placeholder="Favorito" name="favorito" value="<?php echo $favorito; ?>" />
                                </div>
                                <div class="input-group form-group">
                                    <div class="form-group">
                                        <label>Numero documento</label>
                                        <input type="text" class="form-control" value="<?php echo $numero_documento; ?>" placeholder="Nombre de usuario" name="documento" required />
                                    </div><br><br>
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" value="<?php echo $nombre; ?>" placeholder="Nombre de usuario" name="nombre" required />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
