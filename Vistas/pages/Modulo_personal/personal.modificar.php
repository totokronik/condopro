        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="../../../Clases/Personal/class.modificar.php" method="POST" accept-charset="utf-8">
                                <?php
                                $id = $_GET['id'];
                                $sql ="SELECT
                                pc.id_usuario as id,
                                ...
                                pc.id_rol as id_rol,
                                pc.id_condominio as condominio,
                                r.nombre_rol as rol
                                FROM personal_condominio pc
                                JOIN roles r ON pc.id_rol = r.id_rol
                                WHERE pc.id_personal_condominio = $id";
                                ...
                                <div class="form-group" style="display: none;">
                                    <input type="text"  value="<?php echo $row['id']; ?>" name="usuario" />
                                </div>
                                <div class="form-group" style="display: none;">
                                    <input type="text"  value="<?php echo $row['condominio']; ?>" name="condominio" />
                                </div>
                                <div class="form-group" style="display: none;">
                                    <input type="text" value="<?php echo $row['personal']; ?>" name="personal" />
                                </div>
                                ...
                                <div class="form-group">
                                    <a href="personal.index.php" class="btn btn-block btn-warning">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
