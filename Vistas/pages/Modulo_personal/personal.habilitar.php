        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <b>Lista de personal inhabilitado</b>
                </div><br>
                <div class="row">
                    <div class="col-md-12">
                        &nbsp;&nbsp;&nbsp;
                        <a href="personal.index.php" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-eye-open"></span> Personal Habilitado</a>
                    </div>
                </div>
                <!-- /.panel-heading -->
                    ...
                    <table width="100%" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <a href="../../../Clases/Personal/class.habilitar.php?id=<?php echo $row['id'];?>&condominio=<?php echo $row['id_condominio'];?>&user=<?php echo $_SESSION['username']; ?>" class="btn btn-success btn-block"><i class="fa fa-check"> Habilitar Personal</i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
