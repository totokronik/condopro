...
if ($_SESSION['perfil'] == 4 || $_SESSION['perfil'] == -1 || $_SESSION['perfil'] == 7) {
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <br>
                <!-- /.panel-heading -->
                <form action="../../../Clases/Personal/class.agregar.php" method="POST" accept-charset="utf-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <fieldset><label>Rol</label>
                                <select class="form-control form-control-static" name="rol" id="rol" required>
                                    <?php
                        ...
                        <div class="form-group">
                            <div class="input-group form-group">
                                ...
                                <select class="form-control form-control-static" name="usuario" id="usuario" required>
                                    <?php
                                    $consulta = "SELECT * FROM usuarios where id_usuario not in (0)";
                                    $resultado = mysqli_query($conexion, $consulta);
                                    while ($row = $resultado->fetch_assoc()) {
                                    ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <a href="personal.index.php" class="btn btn-block btn-warning btn-lg">Volver</a>
                    </div>
                </div>
            </div>
        </div>
