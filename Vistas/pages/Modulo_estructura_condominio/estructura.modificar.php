        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <form action="../../../Clases/Estructura_condominio/class.modificar.php" method="POST">
                            <?php
                            $estructura = $_GET['id'];
                            $consulta = "SELECT
                                        ...
                                        WHERE ec.id_estructura_condominio = $estructura";
                            $resultado = mysqli_query($conexion, $consulta);
                            while($fila = $resultado->fetch_assoc()){
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="torre" class="form-control" placeholder="Nombre de la torre, Ejemplo: América" required>
                            </div>
                            <div class="form-group">
                                <label>Unidad</label><br>
                                &nbsp;&nbsp;&nbsp;<label style="color: grey;">Identificador Unidad anterior: <i><?php echo $fila['unidad']; ?></i></label>
                            ...
                            <div class="form-group">
                                ...
                                <a href="estructura.index.php" class="btn btn-warning btn-block">Volver</a>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-1"></div>
