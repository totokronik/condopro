		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<div class="row">
					<div class="col-md-12">
						&nbsp;&nbsp;&nbsp;
						<a href="estructura.index.php" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-eye-close"></span> Estructura de Condominios Habilitados</a>
					</div>
				</div>
					...
					<table width="100%" class="table table-striped table-bordered" id="example">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								...
								<td>
									<a href="../../../Clases/Estructura_condominio/class.habilitar.php?id=<?php echo $fila['id_estructura']; ?>&user=<?php echo $_SESSION['username']; ?>" class="btn btn-success btn-block"><i class="fa fa-check"></i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
