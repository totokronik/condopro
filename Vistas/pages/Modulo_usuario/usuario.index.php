                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                &nbsp;&nbsp;&nbsp;
                                <a href="usuario.agregar.php" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-plus"></span> Nuevo Usuario</a>
                                <a href="usuario.habilitar.php" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-eye-close"></span> Usuarios Inhabilitados</a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * from usuarios WHERE activo = 1 AND id_usuario <> 0";
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="usuario.modificar.php?id=<?php echo $row['id_usuario'];?>" title="Modificar" class="btn btn-info btn-block"><i class="fa fa-pencil"></i></a>
                                            <a href="../../../Clases/Usuario/class.inhabilitar.php?id=<?php echo $row['id_usuario'];?>" title="Inhabilitar" class="btn btn-warning btn-block"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                    <?php  } ?>
                                </tbody>
