        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <br>
                    <!-- /.panel-heading -->
                    <form action="../../../Clases/Usuario/class.agregar.php" method="POST" accept-charset="utf-8">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Número de documento" maxlength="10" name="rut" required/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="activoRadio" id="activoRadio1" value="1" checked>Si
                                            </label>&nbsp;&nbsp;&nbsp;
                                            <label>
                                                <input type="radio" name="activoRadio" id="activoRadio2" value="0">No
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
