            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <b>Usted se encuentra en <?php 
                    ...
                    <li class="dropdown">
                        ...
                        <?php
                            if($_SESSION['perfil'] == 1 || $_SESSION['perfil'] == 4 || $_SESSION['perfil'] == 5 || $_SESSION['perfil'] == 6 || $_SESSION['perfil'] == 7){
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <br>
                <!-- /.panel-heading -->
                <form action="../../../Clases/Residente/class.agregar.php" method="POST" accept-charset="utf-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <div class="input-group form-group">
                                    <fieldset><label>Usuario</label>
                                    <select class="form-control form-control-static" name="usuario" id="usuario" required>
                                        <?php
                                        $consulta = "SELECT * FROM usuarios WHERE id_usuario <> 0";
                                        $resultado = mysqli_query($conexion, $consulta);
                                        while ($row = $resultado->fetch_assoc()) {
                                        ?>
                                        <option value="<?php echo $row['id_usuario'];?>"><?php echo $row['username']; ?></option>
                                        <?php } ?>
                                    </select>
                                </fieldset><br>
                                <div class="input-group form-group">
                                    ...
                                    <select class="form-control form-control-static" name="estructura" id="estructura" required>
                                        <?php
                                        $consulta = "SELECT * FROM estructura_condominio where unidad <> '00000' ";
                                        $resultado = mysqli_query($conexion, $consulta);
                                        while ($row = $resultado->fetch_assoc()) {
                                        ?>
