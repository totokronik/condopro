...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Gestión de Residente</h1>
        </div>
    </div>
    <!-- /.row -->
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <br>
                <!-- /.panel-heading -->
                <form action="../../../Clases/Residente/class.modificar.php" method="POST" accept-charset="utf-8">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <?php
                                $residente = $_GET['id'];
                                $sql = "SELECT
                                rc.id_estructura_condominio as id_estructura,
                                ec.unidad as unidad,
                                ...
                                <div class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" placeholder="Condominio" name="condominio" value="<?php echo $condominio; ?>" />
                                </div>
                                <div class="form-group" style="display: none;">
                                    <label>Residente</label>
                                    <input type="text" class="form-control" placeholder="Residente" name="residente" value="<?php echo $residente; ?>" />
                                </div>
                                <div class="form-group">
                                    <fieldset><label>Estructura condominio</label>
                                    <select class="form-control form-control-static" name="estructura" id="estructura" required>
                                        <optgroup label="Opcion actual">
                                            <option value="<?php echo $estructura;?>"><?php echo $unidad; ?></option>
                                        </optgroup>
                                        <optgroup label="Opciones">
                                            <?php
                                            $consulta = "SELECT * FROM estructura_condominio";
                                            $resultado = mysqli_query($conexion, $consulta);
                                            while ($row = $resultado->fetch_assoc()) {
                                            ?>
                                            <option value="<?php echo $row['id_estructura_condominio'];?>"><?php echo $row['unidad']; ?></option>
                                            <?php } ?>
                                        </optgroup>
                                    </select>
                                </fieldset><br>
                                ...
                                <div class="form-group">
                                    <a href="residente.index.php" class="btn btn-block btn-warning btn-lg">Volver</a>
                                </div>
                            </div></div>
                        </div>
                    </div>
