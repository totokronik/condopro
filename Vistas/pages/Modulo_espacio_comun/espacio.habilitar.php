        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <b>Lista de espacios comunes inhabilitados</b>
                </div><br>
                <div class="row">
                    <div class="col-md-12">
                        &nbsp;&nbsp;&nbsp;
                        <a href="espacio.index.php" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-eye-open"></span> Espacios Comunes Habilitados</a>
                    </div>
                </div>
                <!-- /.panel-heading -->
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="../../../Clases/Espacio_comun/class.habilitar.php?id=<?php echo $row['id'];?>&username=<?php echo $_SESSION['username']; ?>" class="btn btn-success btn-block"><i class="fa fa-check"></i></a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
