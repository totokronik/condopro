                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                &nbsp;&nbsp;&nbsp;
                                    <a href="favorito.agregar.php" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-plus"></span> Nuevo Favorito</a>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                    <?php 
                                        $sql = "SELECT * FROM favoritos_residente";
