...
<html lang="en">
    ...
    <!-- /.navbar-static-side -->
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Favoritos</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                &nbsp;&nbsp;&nbsp;
                                    <a href="favorito.agregar.php?residente=<?php echo $id_residente; ?>" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-plus"></span> Nuevo Favorito</a>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody>
                                    <?php 
                                        $sql = "SELECT * FROM favoritos_residente WHERE id_residente = $id_residente";
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            <td style="display: none;"><?php echo $row['id_favorito']; ?></td>
                                            ...
                                            ?></td>
                                            <td>
                                                <a href="favorito.modificar.php?id=<?php echo $row['id_favorito'];?>" title="Modificar" class="btn btn-info btn-block"><i class="fa fa-pencil"></i></a>
                                                <a href="../../../Clases/Favorito/class.eliminar.php?id=<?php echo $row['id_favorito'];?>" title="Inhabilitar" class="btn btn-warning btn-block"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>   
                                    </tbody>
